    ...
    <div class="notes">
        ...
        <ol>
            ...
            <li>
                ...
                <p>
                    ...
                    direct bettors to vote in a certain way or to manipulate the
                    outcome.
                </p>
            </li>
            <li>
        ...
        <ol>
            <li>
                ...
                <p>
                    Wagers are subject to the rules in place at the time the
                    wager is created. No changes to the rules will be made
                    retroactively.
                </p>
            </li>
            <li>
